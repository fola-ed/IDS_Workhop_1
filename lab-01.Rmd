...
**NA means not available which means there must be an entry that has NA in the attribute n_2021 **
...
**it removes any entry that has NA in the n_2021 attribute**
...
**it means the values for the visitors for each attraction is widely varied **
